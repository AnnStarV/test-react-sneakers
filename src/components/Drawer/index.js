                    ...
                    <><div className={styles.shoppingList}>
                            ...
                            {items.map((obj) => (
                                <div key={obj._id} className={styles.shopItem}>
                                    ...
                                    <img onClick={() => onRemove(obj._id)} className={styles.delete} src="/assets/images/delete.svg" alt="delete" />
                                </div>
                            ))}
                        </div><div className={styles.orderInfo}>
                    ...
                    <div className={styles.cartEmpty}>
                        <div className={styles.cartEmptyWrapper}>
                            ...
                            <button onClick={onClickCross}>
                                <img src={"/assets/images/arrow.svg"}></img>
